...
const DeleteMeja = (meja: Meja) => {
    ...
    return (
        <div>
            <button className="btn bg-emerald-500 text-white border-none" onClick={handleChange}>
                Delete
            </button>
            <input
                type="checkbox"
            ...
            <div className="modal text-gray">
                <div className="modal-box bg-emerald-100">
                    ...
                    <div className="modal-action">
                        ...
                        {!isMutating ? (
                            <button type="button" onClick={() => handleDelete(meja.id)} className="btn bg-emerald-800 text-white border-none">
                                Delete
                            </button>
                        ) : (
