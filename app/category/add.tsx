...
const AddCategory = () => {
  ...
  return (
    <div>
      <button className="btn bg-emerald-800 text-white border-none" onClick={handleChange}>
        Add New
      </button>
      <input
        type="checkbox"
      ...
      />
      <div className="modal text-emerald-950">
        <div className="modal-box bg-emerald-200">
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-control">
              ...
              <input
                ...
                className="input w-full input-bordeemerald text-gray bg-emerald-100"
